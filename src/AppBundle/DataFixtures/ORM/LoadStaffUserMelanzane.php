...
//src\AppBundle\DataFixtures\ORM\LoadStaffUserGlenshire
...
class LoadStaffUserMelanzane extends AbstractFixture implements  ContainerAwareInterface, OrderedFixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $discriminator->setClass('AppBundle\Entity\Staff');
        ...
        $org->setTemp(true);
        $foc1 = $manager->getRepository("TruckeeVolunteerBundle:Focus")->findOneByFocus('Seniors');
        $org->addFocus($foc1);
        $manager->persist($org);
