 ...
 * @ORM\Entity(repositoryClass="AppBundle\Entity\OpportunityRepository")
 */
class Opportunity
{
     ...
     *
     * @ORM\ManyToOne(targetEntity="AppBundle\Entity\Organization", inversedBy="opportunities", cascade={"persist","remove"})
     * @ORM\JoinColumns({
     ...
     *
     * @ORM\OneToMany(targetEntity="AppBundle\Entity\Search", mappedBy="opportunity", cascade={"persist","remove","merge"})
     */
    protected $searches;
