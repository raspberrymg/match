...
class AdminControllerTest extends WebTestCase
{
    ...
    {
        $crawler = $this->login('admin');
        $this->assertGreaterThan(0, $crawler->filter('html:contains("Admin home page")')->count());
    }
    ...
    public function testSendVolunteerEmail()
    {
        ...
        $crawler = $this->client->submit($form);
        $this->assertGreaterThan(0, $crawler->filter('html:contains("e-mail was sent")')->count());
    }
